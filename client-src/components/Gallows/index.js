            ...
            <Svg width='150' viewBox='0 0 380 512' xmlns='http://www.w3.org/2000/svg'>
                <g fill='none' fillRule='evenodd'>
                    ...
                    <g transform='translate(208 116)' stroke='#000' strokeWidth='15'>
                        ...
                        {lives < 3 &&
                            <path strokeLinecap='square' d='M54.5 133.5V201.308l6.277 41.848'/>
                            //туловище
                        }
                        {lives < 1 &&
                            <path strokeLinecap='square' d='M63 247l26.778 58.604-10.864 53.362'/>
                            //правая нога
                        }
                        {lives < 1 &&
                        ...
                        {lives < 2 &&
                            <path strokeLinecap='square' d='M56 143l35 45.496 11.132 44.605'/>
                            //правая рука
                        }
                        {lives < 2 &&
                            <path d='M53.272 143c-14.153 23.154-24.587 39.19-31.303 48.11-6.716 8.92-14.04 24.956-21.969 48.11' strokeLinecap='square'/>
                            //левая рука
                        }
                        {lives < 4 &&
